...
O arquivo `config.yaml` habilita apenas o MCP Marketing Ops neste primeiro corte. No Hermes v0.20.6, esta é a fonte efetivamente lida pelo runtime; `mcp.json` permanece vazio e versionado somente como parte do formato oficial da distribuição. RAG e Picture serão adicionados quando seus serviços forem migrados e testados contra o Hermes oficial.
