...
| Marketing Ops e cutover (M6) | Fluxo funcional homologado; recibos e planos sequenciais aprovados localmente; Checkpoint 7 VPS pendente | [desenho M6](plans/2026-09-13-m6-marketing-ops-and-cutover-design.md), [execução estruturada](plans/2026-09-14-structured-marketing-ops-plan-execution-design.md), [delegação opaca](plans/2026-09-15-opaque-marketing-ops-delegation-design.md), [recibos e planejamento sequencial](plans/2026-09-17-m6-plan-receipts-and-sequential-planning-design.md), [plano TDD final](plans/2026-09-17-m6-plan-receipts-and-sequential-planning-implementation.md), [runbook](operations/m6-marketing-ops-cutover.md) e [ADR-0004](decisions/ADR-0004-structured-marketing-ops-plan-execution.md) |
...
M1–M5 estão concluídos. No M6, o card estruturado, o botão **Executar plano**,
a delegação opaca por Run, a criação de um segundo gestor e a decisão humana
segregada já foram homologados na VPS. A etapa local final mantém cada plano
como um recibo persistente no chat e permite novos planos independentes na mesma
conversa, sempre com nova Run e nova referência opaca. O M6 permanece não
concluído até a homologação assistida do Checkpoint 7 na VPS.
