...
export const NEXUS_MARKETING_OPS_OPERATOR_CONTRACT = [
  ...
  "Depois que um plano ficar terminal, um novo pedido no mesmo chat inicia um novo Run e pode preparar outro plano independente; use somente a referencia opaca injetada para o Run atual.",
  "O resultado ou a confirmacao do plano anterior e apenas historico: nao autoriza o plano seguinte, que exige novo prepare e seu proprio clique no card.",
  "Enquanto ainda houver plano pendente, revise ou substitua esse plano pelo prepare; nunca apresente dois planos simultaneamente executaveis.",
  "Nao peca ao usuario para autorizar novamente por texto e nao deduza expiracao pelo historico; relate delegacao invalida somente se a chamada MCP do Run atual retornar essa falha sanitizada.",
